...
import { PartnerRequestSection } from "../components/PartnerRequest";
  ...
  return <>
    ...
    <main className="interior-page">
      <section className="partner-hero-page">
        ...
        <div data-reveal><span className="eyebrow">BUGSHA FOR BUSINESSES</span><h1>Be one of the first kitchens on Bugsha.</h1><p>We are opening in Kuwait and Egypt and signing our first partner kitchens now. List tonight’s surplus without changing your kitchen workflow—Bugsha handles discovery, payment and the collection record.</p><a className="button button-primary" href="#request">Request a partner code <Arrow /></a></div>
      </section>
      ...
      <section className="portal-section">
        ...
        <div className="portal-window" data-reveal="scale"><div className="browser-bar"><i /><i /><i /><span>partner.bugsha.app</span></div><img src="/assets/partner-list-en.png" alt="Bugsha partner portal listing screen" /><div className="portal-detail"><img src="/assets/partner-ledger-en.png" alt="Bugsha inspection log" /></div></div>
      </section>
      ...
      <section className="business-cta" data-reveal><span className="eyebrow light">READY WHEN YOU ARE</span><h2>Open with us, not after us.</h2><p>Questions before you ask for a code? We will walk through it with you before your city goes live.</p><a className="button button-light" href="mailto:partners@bugsha.app">partners@bugsha.app <Arrow /></a></section>
    </main>
    <SiteFooter />
  </>;
}
